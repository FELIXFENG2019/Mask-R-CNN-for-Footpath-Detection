...
class FootpathDataset(utils.Dataset):
    ...
    def load_footpath(self, dataset_dir, subset):
		...
		self.add_class("footpath", 3, "obstacles")
...
dataset_train.load_footpath(500, config.IMAGE_SHAPE[0], config.IMAGE_SHAPE[1])
dataset_train.prepare()

# Validation dataset
dataset_val = FootpathDataset()
dataset_val.load_footpath(50, config.IMAGE_SHAPE[0], config.IMAGE_SHAPE[1])
dataset_val.prepare()
